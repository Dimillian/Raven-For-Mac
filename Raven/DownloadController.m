...
static DownloadController *sharedUserManager = nil;
...
-(void)writeDownloadInplist
{
    ...
    DownloadObject *object = [[DownloadObject alloc]initWithKey:number name:@"hey" progress:number size:number path:@"hey" progressBytes:number source:@"Jey"]; 
